        ...
        return (
            <div className="page">
                <div class="container docs">
                    <h1 className="mt-5 mb-4">Docs</h1>
                    ...
                    <h2 className="mt-4">Installation</h2>
                    ...
                    <p>You can now use it into your different React components or JSX code like bellow:</p>
                    ...
                    <h3 className="mt-5">audio</h3>
                    <p><code>String</code> property containing a link to an audio file. It can be a link to a local or distant link. This property is <span class="highlight">mandatory</span> for any audio player.</p>
                    <snippet-highlight theme="dark" language="jsx" content={audioCode} />
                    <h3 className="mt-5">autoplay</h3>
                    ...
                    <ul>
                        <li><code class="property">img</code>: (<span class="highlight">mandatory</span>) <code>String</code> property containing the link of the image that will be displayed in the button. It can be a link to a local or distant file.</li>
                        <li><code class="property">style</code>: <code>Object</code> property containing CSS properties to add additional styling elements to the button image.</li>
                    </ul>
                    <p>Then you have to choose between the following properties:</p>
                    <ul>
                        <li><code class="property">href</code>: <code>String</code> property containing the link where to redirect the user when he/she clicks on the button.</li>
                        <h6 class="mt-2">OR</h6>
                        <li><code class="property">callback</code>: <code>Function</code> property containing the callback that will be executed anytime a user click on the button</li>
                    </ul>
                    ...
                    <h3 className="mt-5">logo</h3>
                    <p><code>Object</code> property that can contain 2 properties:</p>
                    <ul>
                        <li><code class="property">img</code>: (<span class="highlight">mandatory</span>) <code>String</code> property containing the link of the logo image. It can be a link to a local or distant file.</li>
                        <li><code class="property">href</code>: <code>String</code> property containing the link where to redirect the user when he/she clicks on the logo.</li>
                    </ul>
                    <snippet-highlight theme="dark" language="jsx" content={logoCode} />
                    <h3 className="mt-5">muted</h3>
                    ...
                    <h3 className="mt-5">slideshow</h3>
                    ...
                    <p>Each <code>Object</code> can contain 3 properties :</p>
                    <ul>
                        <li><code class="property">img</code>: (<span class="highlight">mandatory</span>) <code>String</code> property containing the link of the image that will be added to the slideshow. It can be a link to a local or distant file.</li>
                        <li><code class="property">endTime</code>: <code>Float</code> property telling at what time should disappear the image. If it is the first image of the list it will start from time <code>0.0</code> to time <code>endTime</code>. For the next images of the list, it will start from the previous image <code>endTime</code> to its own <code>endTime</code></li>
                    </ul>
                    <p>This property is <span class="highlight">mandatory</span> for any slideshow player. You can add the <code class="property">audio</code> property to add a soundtrack to the slideshow.</p>
                    <snippet-highlight theme="dark" language="jsx" content={slideshowCode} />
                    <h3 className="mt-5">style</h3>
                    ...
                    <h3 className="mt-5">thumbnail</h3>
                    ...
                    <h3 className="mt-5">titleHref</h3>
                    ...
                    <p><code>String</code> property containing a link to a video file. It can be a link to a local or distant file. This property is <span class="highlight">mandatory</span> for any video player</p>
                    <snippet-highlight theme="dark" language="jsx" content={videoCode} />
                    <h3 className="mt-5">vinyl</h3>
                    <p><code>Object</code> property that can contain 2 properties:</p>
                    <ul>
                        <li><code class="property">img</code>: (<span class="highlight">mandatory</span>) <code>String</code> property containing the link of the image that will be displayed as vinyl. It can be a link to a local or distant file.</li>
                        <li><code class="property">rpm</code>: <code>Integer</code> property standing for the spinning speed of the vinyl in "round per minute"</li>
                    </ul>
                    <snippet-highlight theme="dark" language="jsx" content={vinylCode} />
                    <h3 className="mt-5">width</h3>
                    ...
                    <h3 className="mt-5">Vertical align</h3>
                    <h3 className="mt-5">Horizontal align</h3>
                    <h3 className="mt-5">Vertical & Horizontal align</h3>
